...
export default class List extends React.PureComponent {
      ...
      return(
        <div style={detailsContainer}>
          <div style={detail}>
            ...
            <div style={detailPhone}> PHONE #: {this.state.data.phone} </div>
            <div style={detailWebsite}> <a href={this.state.data.website} target='_blank'>Website Link (if available)</a> </div>
          </div>
        </div>
      )
    }
  ...
  render() {
    ...
    return (
      <div>
        <Helmet title="List" meta={[ { name: 'description', content: 'UPA CIN Physician Directory' }]}/>
